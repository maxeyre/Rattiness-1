...
# Script: Fitting the full model excluding the traps index
...
# Description: In this script we fit the full geostatistical model without the traps index. Please see the published article for a 
