# PredictionExcPlates.R

# Script: Spatial prediction of Rattiness for the full model excluding the plates index
...
# the dataset 2-PdLPredictionGrid.csv using the full geostatistical model without the plates index. Please see the 
