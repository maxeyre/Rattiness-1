# PredictionExcTraps.R

# Script: Spatial prediction of Rattiness for the full model excluding the traps index
...
# the dataset 2-PdLPredictionGrid.csv using the full geostatistical model without the traps index. Please see the 
